...
public class Server
{
    ...
    private static void TCPConnectCallback(IAsyncResult _result)
    {
        ...
        Debug.Log($"{_tcpClient.Client.RemoteEndPoint} failed to connect. Server fully occupied");
    }
    ...
    private static void UDPReceiveCallback(IAsyncResult _result)
    {
        ...
        {
            Debug.Log($"UDPReceiveCallback malfunctioning with exception {_e}");
        }
    }
    ...
    public static void SendUDPData(IPEndPoint _clientEndPoint, Packet _packet)
    {
        ...
        {
            Debug.Log($"Cannot send UDP packet. Exception {_e}");
        }
    }
